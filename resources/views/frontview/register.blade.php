        ...
        <div class="ltn__utilize-menu-inner ltn__scrollbar">
            ...
            <div class="mini-cart-footer">
                ...
                <div class="btn-wrapper">
                    <a href="{{url('cart')}}/#cart" class="theme-btn-1 btn btn-effect-1">Lihat Keranjang</a>
                    <a href="{{url('cart')}}/#cart" class="theme-btn-2 btn btn-effect-2">Checkout</a>
                </div>
                <p>Diskon 10% spesial hari kemerdekaan</p>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="ltn__breadcrumb-inner ltn__breadcrumb-inner-2 justify-content-between">
                        <div class="section-title-area ltn__section-title-2">
                            ...
                            <h1 class="section-title white-color">Daftar sekarang dan checkout barangmu</h1>
                        </div>
                    ...
                    <div class="account-login-inner">
                        ...
                        <div class="by-agree text-center">
                            ...
                            <div class="go-to-btn mt-50">
                                <a href="{{url('login')}}/#login">ALREADY HAVE AN ACCOUNT ?</a>
                            </div>
                        </div>
                    </div>
                </div>
